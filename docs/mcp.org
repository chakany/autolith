...
templates, prompts, and bounded server instructions.
...
- One MCP manager retains at most 1,024 advertised tools
...
- Autolith keeps at most 2,000 credential-sanitized characters of
  server instructions per server and per request
