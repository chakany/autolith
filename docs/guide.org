...
The check runs FiveAM tests in four isolated SBCL processes and verifies the
pristine recovery image. List or select test suites and individual cases with:
