...
Autolith supports Linux x86-64 and macOS via Nix. Packaged
binary releases are available for Linux x86-64, but not yet for macos (good first issue? hmm?).
...
In Autolith, the message window is just a LISP repl with familiar 
