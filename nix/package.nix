...
let
  ...
  clinedi = pkgs.sbcl.buildASDFSystem {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "luciusmagn";
      repo = "clinedi";
      rev = "f7c158e396ab4630b0b3a8e427346f8143afea87";
      hash = "sha256-uDcEnP4DUQNHW0kZ6heGpp06nqv4kxPWz92ASHfhGqo=";
    };
    lispLibs = [ clColorist ];
  };
  ...
  sbclWorkers = pkgs.sbcl.buildASDFSystem {
    ...
    src = pkgs.fetchFromGitHub {
      owner = "luciusmagn";
      repo = "sbcl-workers";
      rev = "3cda0dbfa5570ce1d4f917131d69c2f976be289d";
      hash = "sha256-PoMRixMZJ4gJz5CRx+ov4crMkKC5sXFgTV3hN6Jklp0=";
    };
    lispLibs = with pkgs.sbclPackages; [
      bordeaux-threads
      sexpStore
